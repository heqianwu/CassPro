...
public class HBigFileReader {
    private int threadSize;
    private String charset;
    private int bufferSize;
    private HIHandle handle;
    ...
    private HBigFileReader(File file, HIHandle handle, String charset, int bufferSize, int threadSize) {
        ...
        startEndPairs = new HashSet<HBigFileReader.StartEndPair>();
    }
    ...
    public void start() {
        ...
        cyclicBarrier = new CyclicBarrier(startEndPairs.size(), new Runnable() {
            ...
            public void run() {
                ...
                System.out.println("all non-empty line: " + counter.get());
                shutdown();
            }
        });
    ...
    public static class Builder {
        ...
        public Builder(String file, HIHandle handle) {
        ...
        public HBigFileReader build() {
            return new HBigFileReader(this.file, this.handle, this.charset, this.bufferSize, this.threadSize);
        }
    }
